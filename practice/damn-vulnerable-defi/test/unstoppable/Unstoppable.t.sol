...
contract UnstoppableChallenge is Test {
    ...
    function test_unstoppable() public checkSolvedByPlayer {
        // Break ERC4626 invariant: direct transfer bypasses deposit(), making
        // totalAssets > totalSupply. The flashLoan() invariant check
        // `convertToShares(totalSupply) == balanceBefore` will revert forever.
