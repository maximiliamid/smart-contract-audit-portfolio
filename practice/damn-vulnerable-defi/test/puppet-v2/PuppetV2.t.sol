...
contract PuppetV2Challenge is Test {
    ...
    function test_puppetV2() public checkSolvedByPlayer {
        // Same pattern as Puppet but Uniswap V2. Dump all 10,000 DVT into
        // V2 pair — WETH reserve in pair increases, DVT reserve increases,
        // so DVT price in WETH terms crashes. Borrow pool w/ tiny WETH.

        // 1) Approve router for full token balance
        ...
        // 3) Wrap all remaining ETH to WETH
        weth.deposit{value: player.balance}();

        // 4) Borrow whole pool with minimal WETH collateral
